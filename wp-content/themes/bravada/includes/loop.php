	...
	if ( ! empty( $featured_image[0] ) ) {
		...
		<div class="post-thumbnail-container" <?php cryout_schema_microdata( 'image' ); ?>>
			...
			<picture class="responsive-featured-image">
				...
				<?php } ?>
				<img width="<?php echo absint( $featured_image[1] ) ?>" height="<?php echo absint( $featured_image[2] ) ?>" alt="<?php the_title_attribute();?>" <?php cryout_schema_microdata( 'url' ); ?> src="<?php echo esc_url( cryout_get_picture_src( $fimage_id, 'bravada-featured' ) ); ?>" loading="lazy">
			</picture>
